...
<body class="login-layout">
							...
							<div id="login-box" class="login-box visible widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<!-- 	<form action="student/listStudentBootstrapTable3" method="post"> -->
										<fieldset>
											<label class="block clearfix"> <span class="block input-icon input-icon-right"> <input type="text" class="form-control" placeholder="Username" id="name"
											...
											<div>
												<input type="radio" data-toggle="tooltip" data-placement="bottom" title="合同制" name="hetong" value="8" /> <label for="killOrder1">是</label>&nbsp&nbsp&nbsp&nbsp&nbsp
												&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="radio" data-toggle="tooltip" data-placement="bottom" title="外包制" name="hetong"
													value="2" /> <label for="killOrder2">否</label>
											</div>
											<div class="space"></div>
											<div class="input-group">
											...
											<div class="clearfix">
												...
												<!-- 	<button  onclick="rr()" class="width-35 pull-right btn btn-sm btn-primary">
														<i class="icon-key"></i> 登录
												</button>  -->
												<input name="登录" class="width-35 pull-right btn btn-sm btn-primary" type="button" id="btn1" title="登注册" value="登录"
													onclick="location.href='http://localhost:8081/GzMavenSSM/student/listStudentBootstrapTable3?aa='+document.getElementById('name').value+''" />
											</div>
	...
	<script>
	function rr(){
	var cc=	document.getElementById('name').value;
	console.log(",,,,,,,,,,,"+cc);
		location.href='http://localhost:8080/GzMavenSSM/student/listStudentBootstrapTable3?aa='+cc;
	};
...
return new Date().getTime();
	...
	$(document).ready(function(){
		 dddf=document.getElementById('name').value;
	});
